...
class WebLogin {
	...
	def loginSociolla(){
		...
		WebUI.verifyElementPresent(findTestObject('login/Page_Situs Kosmetik Terlengkap  Terpercaya _e5bd73/Page_Situs Kosmetik Terlengkap  Terpercaya 1 di Indonesia - Sociolla/p_Masuk dengan akun SOCO'),
				0)
		...
		WebUI.setEncryptedText(findTestObject('Object Repository/login/Page_Situs Kosmetik Terlengkap  Terpercaya _e5bd73/input_Password_password'),
				'RoxFy4LIkdOSa4SibfMO6w==')

		WebUI.click(findTestObject('Object Repository/login/Page_Situs Kosmetik Terlengkap  Terpercaya _e5bd73/button_MASUK KE SOCIOLLA'))
	}
	/**
	 * Refresh browser
	 */
